            ...
            <ul className="space-y-1.5 mb-2">
              {selectedAgents.map((agent) => (
                <li key={agent.id} className="flex items-center gap-2.5">
                  <div className="w-7 h-7 rounded-full bg-accent-primary/15 border border-accent-primary/25 flex items-center justify-center text-base shrink-0">
                    {agent.avatar}
                  </div>
              ...
              <li className="flex items-center gap-2.5 pt-1.5 border-t border-workspace-border/40">
                <div className="w-7 h-7 rounded-full bg-workspace-bg border border-workspace-border flex items-center justify-center text-base shrink-0">
                  👤
                </div>
